...
TODO: profile this, and the rest of hadoopio.io! cython speedups,
perhaps?
...
class HdfsFileInputStream(InputStream.FileInputStream):
    """meets hadoopio interface, at least all the bits that
...
class SequenceFileReader(pp.RecordReader):
    ...
    the types org.apache.hadoopio.io.Text etc, but other classes
